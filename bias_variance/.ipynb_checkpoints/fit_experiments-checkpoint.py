...
class PolynomialRegression:
    ...
    def evaluate(self, x, y):
        return np.mean((self.poly(x) - y) ** 2)
...
def tune_experiment(num_trials, train_size, min_degree, max_degree, source):
    """ Plot squared bias, variance and their sum across a range of
    polynomial degrees.  Note that max_degree is EXCLUSIVE: passing
    min_degree=0, max_degree=8 covers degrees 0 through 7.
    """
    biases = []
    variances = []
